        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(PatientNamet)){
                    Toast.makeText(Visit.this,"Add name",Toast.LENGTH_SHORT).show();
                    return;
                }else {
                    if(savedata==true){
                        Toast.makeText(Visit.this,"save user",Toast.LENGTH_SHORT).show();
                        Intent intent =new Intent(Visit.this,VisitB.class);
                        startActivity(intent);
                    }else{
                        Toast.makeText(Visit.this,"exits user,",Toast.LENGTH_SHORT).show();
                    }
                }
